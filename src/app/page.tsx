...
export default function Home() {
    return (
        <div className="mx-20 py-36 2xl:py-48 flex flex-grow overflow-y-hidden">
            <div
                className={`z-100 h-[45%] w-[20%] border-r-0 rounded-r-none fixed top-[12%] border-[rgba(160,160,255,0.40)] border-[1px] rounded-[100px] border-b-0 rounded-b-none left-[80px]`}
            ></div>
            <div className="z-100 h-[45%] w-[20%] border-l-0 rounded-l-none fixed top-[12%] border-[rgba(160,160,255,0.40)] border-[1px] rounded-[100px] border-b-0 rounded-b-none right-16"></div>
